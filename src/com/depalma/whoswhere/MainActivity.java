...
public class MainActivity extends ActionBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mohawk.add(new LatLng(43.204426, -79.851607));
		mohawk.add(new LatLng(43.204284, -79.851107));
		mohawk.add(new LatLng(43.204188, -79.851269));
		mohawk.add(new LatLng(43.204320, -79.851662));
	}
	...
	public void onConnected(Bundle connectionHint) {
		...
		Toast.makeText(this, pnpoly(mohawk, yourMapLocation) ? "We are within" : "Nope", Toast.LENGTH_LONG).show();
	...
	public boolean pnpoly(ArrayList<LatLng> building, LatLng check)
	{
	  ...
	  for (i = 0, j = building.size()-1; i < building.size(); j = i++) {
		  ...
		  Double res = (buildJLong-buildILong) * (checkLat-buildILat) / (buildJLat-buildILat) + buildILong;
	 ...
	 * (item.getItemId()) { case R.id.action_search: openSearch(); return true;
	 * case R.id.action_settings: openSettings(); return true; default: return
	 * super.onOptionsItemSelected(item); } int id = item.getItemId(); if (id ==
